...
export function BackendPending({
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <Card className="data-panel panel-depth reveal-delay-1 reveal-up overflow-hidden">
        <CardContent className="grid gap-6 p-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div className="relative z-10 space-y-4">
            <div className="signal-line flex size-12 items-center justify-center rounded-2xl bg-orange-50 text-orange-600 shadow-[var(--shadow-sm)]">
          ...
          <div className="relative z-10 space-y-3 rounded-2xl border border-slate-200 bg-slate-50/80 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.18)]">
