...
export const courses = [
  {
    ...
    color: "orange",
    chapters: [
      { title: "Pattern First Arrays", lessons: 8, progress: 100 },
      { title: "Hashing and Sliding Windows", lessons: 7, progress: 86 },
      { title: "Trees, Graphs, and Search", lessons: 12, progress: 57 },
      { title: "Dynamic Programming", lessons: 10, progress: 30 },
    ],
  },
  {
    slug: "gate-core-cs",
    title: "GATE Core CS Mastery",
    ...
    color: "sky",
    chapters: [
      { title: "Computer Organization", lessons: 18, progress: 76 },
      { title: "Operating Systems", lessons: 20, progress: 54 },
      { title: "DBMS and Transactions", lessons: 16, progress: 40 },
      { title: "Theory of Computation", lessons: 14, progress: 22 },
    ],
  },
  {
    ...
    color: "violet",
    chapters: [
      { title: "Math for ML", lessons: 9, progress: 90 },
      { title: "Supervised Learning", lessons: 13, progress: 58 },
      { title: "Neural Networks", lessons: 12, progress: 21 },
      { title: "Capstone Project", lessons: 8, progress: 0 },
    ],
  },
  {
    slug: "web-development-road-to-fullstack",
    title: "Road to Full Stack",
    category: "Web Development",
    instructor: "Kabir Sharma",
    progress: 77,
    lessons: 65,
    duration: "59h",
    ...
    color: "emerald",
    chapters: [
      { title: "Modern HTML and CSS", lessons: 12, progress: 100 },
      { title: "React and Next.js", lessons: 18, progress: 83 },
      { title: "APIs and Databases", lessons: 16, progress: 60 },
      { title: "Production Deployment", lessons: 9, progress: 35 },
    ],
  },
];

export const lessons = [
  { title: "Two pointer thinking", duration: "11:42", status: "done" },
  { title: "Sliding window template", duration: "16:10", status: "done" },
  { title: "Longest substring variants", duration: "22:04", status: "active" },
  { title: "Practice set: variable window", duration: "35:00", status: "locked" },
  { title: "AI-generated recap", duration: "5 min", status: "locked" },
];
