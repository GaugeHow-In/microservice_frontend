  ...
  return (
    <AppShell>
      <div className="-mt-6 space-y-12">
        {/* The hero is deliberately the whole first screen (viewport minus the
            4rem sticky header), so everything below it is scroll-revealed. */}
        <section className="hero-aura relative left-1/2 flex min-h-[calc(100vh-4rem)] w-screen -translate-x-1/2 flex-col items-center justify-center overflow-hidden px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          {/* Nothing else is visible on load, so the rest of the dashboard
              needs an explicit cue that it's down there. */}
          <span
            aria-hidden="true"
